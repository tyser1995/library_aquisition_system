...
class GlobalHelper
{
    ...
    public static function getCountryCurrency() {
    	return array (
            'ALL' => 'Albania Lek',
      ...
      return array(
            ...
            "CI" => ["country" => "Cote Divoire", "continent" => "Africa"],
            ...
            "KP" => ["country" => "Democratic Peoples Republic of Korea", "continent" => "Asia"],
            "KR" => ["country" => "Republic of Korea", "continent" => "Asia"],
            "KW" => ["country" => "Kuwait", "continent" => "Asia"],
            "KG" => ["country" => "Kyrgyzstan", "continent" => "Asia"],
            "LA" => ["country" => "Lao Peoples Democratic Republic", "continent" => "Asia"],

                ...
                <div class="col-xl-12 order-xl-1">
                    <div class="card  shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('library_section.update', $library_section) }}" autocomplete="off">
                                @csrf
                                @method('put')
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="section_name" id="input-region-name" class="form-control form-control-alternative" placeholder="{{ __('Enter Section Name') }}" required autofocus value="{{$library_section->section_name}}">
                                    </div>
                                    <div class="form-group">
                                        <h5 class="form-control-label" for="input-region-name">{{ __('Section Code') }}</h5>
                                        <input type="text" name="section_code" id="input-region-name" class="form-control form-control-alternative" placeholder="{{ __('Enter Section Code') }}" autofocus value="{{$library_section->section_code}}">
                                    </div>

            ...
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" autocomplete="off" action="{{route('signature_attachment.update',$signature)}}">
                            @csrf
                            @method('put')
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" class="form-control form-control-alternative"
                                        ...
                                        value="{{ old('password',$signature->password) }}" required autofocus minlength="6">
                                </div>
                            </div>
                            <div class="pl-lg-4">

        ...
        {session && (
            ...
            <Form
              ...
              render={({ handleSubmit }) => (
                <form
                  ...
                  className=" px-8 pt-8  bg-white rounded-md my-16 shadow-md mx-auto w-auto min-h-screen"
                >
                  ...
                  <div className="justify-center  flex items-center">
                    <h3 className="text-xl mb-4 font-bold text-gray-600 ">
                      Sign Up{" "}
                    </h3>
                  </div>

                  <label htmlFor="uname" className="block">
                    <span className="block text-xs font-bold text-gray-500 mb-">
                      ID
                    </span>
                    <Field
          ...
          rounded-md border-gray-300 shadow-sm"
                    ...
                    <label htmlFor="cpassword">
                      <span className="block  text-xs font-bold text-gray-500 ml-3">
                        Confirm Password
                      </span>
                      <Field
           ...
           rounded-md border-gray-300 shadow-sm"
                  ...
                  <label htmlFor="fname" className="block mt-3">
                    <span className="block mt-1 text-xs font-bold text-gray-500 mb-1">
                      Firstname
                    </span>
                    <Field
          ...
          rounded-md border-gray-300 shadow-sm  w-full "
           ...
           rounded-md border-gray-300 shadow-sm w-full"
                  ...
                  <label htmlFor="lname" className="block mt-2">
                    ...
                    <Field
                      className="text-xs font-bold text-gray-500  placeholder-gray-400 focus:placeholder-gray-500 placeholder-opacity-50 rounded-md border-gray-300 w-full shadow-sm "
                      name="lname"
                      component="input"
                      type="text"
                  ...
                  <label htmlFor="selectDosition" className="block mt-2">
                    <span className="block  text-xs font-bold text-gray-500 p">
                      Select Department
                    </span>
                    <Field
                      name="selectDepartment"
                      component="select"
                      className="rounded-md  text-xs font-bold text-gray-500 border-gray-300  mt-1 pr-36 "
                    >
                      <option value="">Select Department</option>
                      <option
                        className="text-xs font-bold text-gray-500"
                        value="COLLEGE OF AGRICULTURE, RESOURCES AND ENVIRONMENTAL SCIENCES"
                      >
                  ...
                  <div className="flex space-x-6 content-around items-center mx-auto mt-3">
                    <label htmlFor="selectPosition" className="block mt-">
                      ...
                      <Field
                        name="selectPosition"
                        component="select"
                        className="rounded-md border-gray-300 text-xs font-bold text-gray-500 mt-1 pr-72"
                      >
                        <option value=""> </option>
                        <option
                          className="text-xs font-bold text-gray-500"
                  ...
                  <div className="flex space-x-6 content-around items-center mt-3">
                    <label htmlFor="email">
                      <span className="block text-gray-500   text-xs font-bold mb-1">
                        Email
                      </span>
                      <Field
                        className="  text-xs font-bold text-gray-500 placeholder-gray-400 focus:placeholder-gray-500 placeholder-opacity-50

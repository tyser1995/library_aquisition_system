...
export const getServerSideProps = async (context) => {
  ...
  const { data } = await api.get(
    `/api/bookrequestpaymentvpaa/${bookIdPaymentFinance}`
  );
          ...
          <Form
            ...
            render={({ handleSubmit }) => (
              <form
                ...
                className=" px-8 pt-8 pb-8 bg-white rounded-md my-16 shadow-md mx-auto w-full min-h-screen"
              >
                <div className="flex-shrink-0 flex content-around items-center">
                  ...
                  <h1 className="text-xl   text-gray-600 ">
                    Finance Request Payment Signature
                  </h1>
                </div>
                ...
                <div className="flex space-x-6 content-around items-center  justify-end">
                  <label htmlFor="date" className=" ">
                    <span className=" text-xs text-gray-500 mb-1 p-8">
                      Aprrove Date
                    </span>
                    <Field
                ...
                <div className="grid grid-cols-3 gap-x-2 p-8 border-1 ">
                  <div className="row-start-1">
                    <label htmlFor="author" className="">
                      <span className=" hover:textColor-red  text-xs  text-gray-500 ">
                        User ID
                      </span>
                      <Field
                        className="block text-gray-500 rounded-md  w-full
                  ...
                  <div className="row-start-2 gap-y-4">
                    ...
                    <small className=" block  text-xs text-gray-500  mr-2 ">
                      Approved By:
                    </small>
                    ...
                    <div className="row-start-4 mt-2 ">
                      <div className="flex space-x-6 content-around items-center mt-5 justify-start ">
                        <label htmlFor="requesID" className="">
                          ...
                          <img
                            src={bookIdPaymentFinance.signatureDean}
                            alt="College Dean Signature"
                            width="100"
                            height="100"
                            className=" border border-gray-blue-900"
                          />
                        ...
                        <label htmlFor="requesID" className="">
                          ...
                          <img
                            src={bookIdPaymentFinance.signatureAcquisition}
                            alt="College Dean Signature"
                            width="100"
                            height="100"
                            className="  border  border-gray-blue-900"
                        ...
                        <label htmlFor="requesID" className="">
                          ...
                          <img
                            src={bookIdPaymentFinance.signtureDirector}
                            alt="College Dean Signature"
                            width="100"
                            height="100"
                            className=" border border-gray-blue-900"
                        ...
                        <label htmlFor="requesID" className="">
                          ...
                          <img
                            src={bookIdPaymentFinance.signatureVPAA}
                            alt="College Dean Signature"
                            width="100"
                            height="100"
                            className="  border border-gray-blue-900"
              ...
              focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
               ...
               focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                ...
                <div className="flex space-x-6 content-around items-center mt-5 justify-start p-8"></div>

            ...
            <Form
              ...
              render={({ handleSubmit }) => (
                <form
                  ...
                  className=" px-8 pt-8  bg-white rounded-md my-16 shadow-md mx-auto w-auto h-auto"
                >
                  ...
                  <div className="justify-center  flex items-center">
                    <h3 className="text-xl m-4 text-gray-600 cursor-not-allowed">
                      Sign Up{" "}
                    </h3>
                  </div>

                  <label htmlFor="uname" className="block">
                    <span className="block text-xs text-gray-500 mb-">
                      User Name
                    </span>
                    <Field
                  ...
                  <label htmlFor="fname" className="block mt-3">
                    <span className="block mt-1 text-xs  text-gray-500 mb-1">
                      Publisher Name
                    </span>
                    <Field
                      className="block mt-2
                  ...
                  <div className="flex space-x-6 content-around items-center mt-3">
                    <label htmlFor="email">
                      <span className="block text-gray-500   text-xs f mb-1">
                        Email
                      </span>
                      <Field
                        className=" block mt-2

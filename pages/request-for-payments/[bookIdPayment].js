...
export const getServerSideProps = async (context) => {
  ...
  return {
    props: { bookIdPayment: data, account },
  };
};
              ...
              >
                <div className="flex-shrink-0 flex content-around items-center">
                  ...
                  <h1 className="text-xl  text-gray-600 ">
                    Director of Library Request Payment Signature
                  </h1>
                </div>
                ...
                <div className="grid grid-cols-3 gap-x-4 gap-y-6 p-8 border-1 ">
                  ...
                  <div className="row-start-3">
                    ...
                    <span className="text-xs  block  text-gray-500 mt-1">
                      Finance: {bookIdPayment.approvalFinance ? "Yes" : "No"}
                    </span>
                  </div>
                  <div className="row-start-4 ">
                    <div className="flex space-x-8 ">
                      <label htmlFor="requesID" className="">
                        ...
                        <img
                          src={bookIdPayment.signatureDean}
                      ...
                      <label htmlFor="requesID" className="">
                        ...
                        <img
                          src={bookIdPayment.signatureAcquisition}
                          alt="College Dean Signature"
                          width="100"
                          height="100"
                          className=" mt-2  border border-1 border-gray-blue-900"
